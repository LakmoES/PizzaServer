...
namespace Pizza.Models
{
    public class ApiContext
    {
        ...
        public ApiContext()
        {
            ...
            Apis.Add(new API { requireToken = false, url = "Product/GetImagesUrl", type = "GET", parameters = "int productID [ID товара]", description = "Изображения товара под номером productID", returns = "Json/bad argument/bad product id/images are not set" });
